...
<body>
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center py-2 px-4 bg-light rounded-3 border custom-card">
            ...
            <h4 class="mb-0 custom-title">Selamat datang di Homepage <?php echo e($pageTitle); ?>.</h4>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/dewinahrisaamelia/Latihan-Git-Arif-Rahmat-Anggi-Risa/resources/views/default.blade.php ENDPATH**/ ?>