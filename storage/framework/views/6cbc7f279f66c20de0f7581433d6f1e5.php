        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                ...
                <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('employees.index')); ?>"
                        class="nav-link <?php if($currentRouteName == 'employees.index'): ?> active <?php endif; ?>">Group Members</a></li>
            </ul>

            <hr class="d-md-none text-white-50">

            <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light my-2 ms-md-auto"><i
                    class="bi-person-circle me-1"></i> Members Profile</a>
        </div>
    </div>
</nav>
<?php /**PATH C:\Users\USER\Latihan-Git-Arif-Rahmat-Anggi-Risa\resources\views/layouts/nav.blade.php ENDPATH**/ ?>